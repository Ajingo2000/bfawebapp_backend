# Generated by Django 5.0.1 on 2024-06-29 07:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bibleBook', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sermons', to='bfaSermons.biblebook')),
                ('sermon_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sermons', to='bfaSermons.sermon_category')),
            ],
            options={
